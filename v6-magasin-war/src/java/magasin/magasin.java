...
public class magasin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((request.getParameter("action") != null)){
            ...
            if (Action.contentEquals("Commande")){ }
        }
...
//out.println( request.getParameter("panier"));

//if ((request.getParameter("action") != null )){
//    out.println( "Reset : " + request.getParameter("action"));
//}
//if ((request.getParameter("action") !=null &&  request.getParameter("action").equalsIgnoreCase("Cancel") )){
//    out.println( "Reset re : " + request.getParameter("action"));
//}
        if ((request.getParameter("action") != null)){
